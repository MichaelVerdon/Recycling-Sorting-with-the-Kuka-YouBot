...
function sysCall_init()
    ...
    pathHandle=sim.getObjectHandle("ConveyorBeltPath#2")
    forwarder=sim.getObjectHandle('ConveyorBelt_forwarder#2')
    sensor=sim.getObjectHandle('ConveyorBelt_sensor#1')
